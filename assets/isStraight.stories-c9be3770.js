...
`]})]})}function l(e={}){const{wrapper:n}=Object.assign({},r(),e.components);return n?t(n,{...e,children:t(c,{...e})}):c(e)}const h=()=>{throw new Error("Docs-only story")};h.parameters={docsOnly:!0};const s={title:"validation/isStraight",tags:["stories-mdx"],includeStories:["__page"]};s.parameters=s.parameters||{};s.parameters.docs={...s.parameters.docs||{},page:l};const w=["__page"];export{w as __namedExportsOrder,h as __page,s as default};
//# sourceMappingURL=isStraight.stories-c9be3770.js.map
